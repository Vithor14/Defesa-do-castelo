...
screen.register_shape("knight2.gif")
screen.register_shape("spartan2.gif")
screen.register_shape("roman2.gif")
screen.register_shape("ninja2.gif")
...
def init01(tipo01):
    ...
    ini01.setheading(0)
    if tipo01 == 0:
        ini01.shape("knight2.gif")
    elif tipo01 == 1:
        ini01.shape("spartan2.gif")
    elif tipo01 == 2:
        ini01.shape("roman2.gif")
    else:
        ini01.shape("ninja2.gif")
    ini01.showturtle()
...
def init02(tipo02):
    ...
    ini02.setheading(0)
    if tipo02 == 0:
        ini02.shape("knight2.gif")
    elif tipo02 == 1:
        ini02.shape("spartan2.gif")
    elif tipo02 == 2:
        ini02.shape("roman2.gif")
    else:
        ini02.shape("ninja2.gif")
    ini02.showturtle()
...
def init03(tipo03):
    ...
    ini03.setheading(0)
    if tipo03 == 0:
        ini03.shape("knight2.gif")
    elif tipo03 == 1:
        ini03.shape("spartan2.gif")
    elif tipo03 == 2:
        ini03.shape("roman2.gif")
    else:
        ini03.shape("ninja2.gif")
    ini03.showturtle()
...
def init04(tipo04):
    ...
    ini04.setheading(0)
    if tipo04 == 0:
        ini04.shape("knight2.gif")
    elif tipo04 == 1:
        ini04.shape("spartan2.gif")
    elif tipo04 == 2:
        ini04.shape("roman2.gif")
    else:
        ini04.shape("ninja2.gif")
    ini04.showturtle()
...
def init05(tipo05):
    ...
    ini05.setheading(0)
    if tipo05 == 0:
        ini05.shape("knight2.gif")
    elif tipo05 == 1:
        ini05.shape("spartan2.gif")
    elif tipo05 == 2:
        ini05.shape("roman2.gif")
    else:
        ini05.shape("ninja2.gif")
    ini05.showturtle()
